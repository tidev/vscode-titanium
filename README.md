...
---                                             | ---                   | ---
Appcelerator: Run                               | `cmd/ctrl-alt-enter`  | Build and run on simulator or device
Appcelerator: Distribute                        | -                     | Build project for Ad-Hoc or App Store distribution
Appcelerator: Stop                              | `cmd/ctrl-alt-.`      | Stop the current build
Appcelerator: Set log level                     | -                     | Set the output log level
Appcelerator: Init                              | -                     | Reload Appcelerator environment information
Appcelerator: Generate autocomplete suggestions | -                     | Build autocomplete database for current default SDK version
Appcelerator: Open related view                 | `cmd/ctrl-alt-v`      | Open the related Alloy XML file
Appcelerator: Open related style                | `cmd/ctrl-alt-s`      | Open the related Alloy TSS file
Appcelerator: Open related controller           | `cmd/ctrl-alt-x`      | Open the related JavaScript file
Appcelerator: Toggle related files              | `cmd/ctrl-alt-a`      | Toggle the related Alloy XML, TSS and Javascript files
...
Autocomplete suggestions can be regenerated by running the `Appcelerator: Generate autocomplete suggestions` command from the command palette.
