...
export class TitaniumTargetDiscovery extends chromeTargetDiscoveryStrategy.ChromeTargetDiscovery {
	...
	public override getTarget (address: string, port: number): Promise<chromeConnection.ITarget> {
	...
	public override async getAllTargets (address: string, port: number): Promise<chromeConnection.ITarget[]> {
